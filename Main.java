...
public class Main {
    ...
    private static void convertCurrency() {
        String[] currencies = {"Peso Argentino (ARS)", "Boliviano (BOB)", "Real Brasiño (BRL)", "Peso Chileno (CLP)", "Peso Colombiano (COP)","Dólar Estadounidense (USD)" };
    ...
    private static double getConversionRate(String baseCurrency, String targetCurrency) throws Exception {
        String url = "https://v6.exchangerate-api.com/v6/cdd1c914680fb3090017271b/latest/" + baseCurrency;
